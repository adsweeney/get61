...
import pandas as pd
from scores_cracks import get_leaderboard, crack_score
...
def main():
    ...
    for name, email in zip(names, emails):
        ...
        score_df, playercodes = get_leaderboard('https://get61.com/leaderboard?lifetime=true&sortBy=lifetime_score', userlist)
        cracks_df = crack_score(playercodes)
        #print(message)
        ...
        """.format(score_df.to_html(), cracks_df.to_html())
